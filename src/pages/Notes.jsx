...
const Notes = () => {
  ...
  return (
    <div className="flex w-full h-screen border-r border-black">
      {/* Main Area */}
      <div className="px-12 py-6 w-3/4 h-screen overflow-y-auto">
                ...
                notes.map((note) => (
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      {/* Note content with strikethrough */}
                      <p
                        className={`mt-[2px]${
                          completedNotes[note.$id]
      ...
      {/* ChatBot */}
      <div className="bg-[#f8f8ec] w-1/4 h-screen"></div>
    </div>
  );
};
